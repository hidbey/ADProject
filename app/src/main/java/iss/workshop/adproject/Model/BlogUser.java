...
public class BlogUser {
    ...
    public BlogUser() {}
    public BlogUser(String displayName, String email,
                    String password, String signupTime,
                    String profilePicture, String location, String education, String aboutMe, String myTechStack,
                    String githubLink, String linkedinLink, BUserStatusEnum userStatus, List<BlogHistory> blogHistories,
...
//        this.postedBlogs = postedBlogs;
    ...
    public String toString() {
        return "BlogUser [userId=" + userId + ", displayName=" + displayName + ", email=" + email + ", password="
                + password + ", signupTime=" + signupTime + ", profilePicture=" + profilePicture + ", location="
                + location + ", education=" + education + ", aboutMe=" + aboutMe + ", myTechStack=" + myTechStack
